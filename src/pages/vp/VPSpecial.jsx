...
import { supabase, TEACHERS, VP_PASSWORD, ML_LIMIT, CL_LIMIT, getSchoolYear, getSchoolYearLabel, countLeaveDays, fetchHolidayDates } from '../../lib/supabase'
import VPHeader from '../../components/VPHeader'

const today = () => new Date().toISOString().split('T')[0]

export default function VPSpecial() {
  ...
  async function grantSL() {
    ...
    await supabase.from('special_leaves').insert({
      ...
      days_count: days, reason: slReason, granted_by: 'vp', school_year: currentSchoolYear,
    })
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#F8F9FB', fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      <VPHeader title="Special Leave" rightExtra={<span style={{ color: 'rgba(255,255,255,0.5)', fontSize: 11 }}>{schoolYearLabel}</span>} />
